---
title: "Zoom Notes 06: Transforming Data"
...
> #### Associated Material
>
> Module: [Module 06 - Transforming data](06-transform.html)
>
> Readings
>
...
```{r zn06-soln3, class.source = "fold-hide", eval = FALSE}
library(tidyverse)
...
```{r zn06-soln4, class.source = "fold-hide", eval = FALSE}
# a)
