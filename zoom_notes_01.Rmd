---
title: "Handout 01 - Introducing R and RStudio"
author: "Murray Cadzow & Patricia Haden"
...
This course is designed with two components - the module and the handout. The module content provides more explanation and background so that you can work through it on your own if you wish. The handout content provides the structure for the content that will be delivered in the online sessions. Both sets of content are complementary to each other.

At the top right hand corner of both the module and handout pages is a "code" button. This can be used to toggle seeing/hiding the code or to download the code that that created the page as an Rmarkdown file (we cover Rmarkdown more in-depth in [module](06-communicate.html)/[handout](handout6.html) 6).
...
We'll cover these in more depth in the Selecting and Filtering [Module](03-subset.html)/[Handout](handout3.html).
...
In the Selecting and Filtering Data module/handout we will cover this more and expand to 2 dimensions.
