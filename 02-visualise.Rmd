...
> 
> ```{r, eval = FALSE}
> download.file(url = "https://raw.githubusercontent.com/rtis-training/2023-s1-r4ssp/main/docs/data/gapminder_data_2007.csv", 
...
>
> The second option is in a web browser go to https://raw.githubusercontent.com/rtis-training/2023-s1-r4ssp/main/docs/data/gapminder_data_2007.csv and then save the page using `Save As` and give it the name "gapminder_data_2007.csv". Save it to your data location.
...
> N.B. if your R version is before v4.0 this command will read in categorical data as _factors_. R will now (v4.0+) automatically treat character data as categorical for the purposes of visualisation. Many statistical methods, however, still require conversion to factors. See the appendix below for more information on creating factors.
