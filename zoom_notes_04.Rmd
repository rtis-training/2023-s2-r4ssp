...
Using ggplot, make a histogram of all the log ChlA values in data frame lakes, with each lake in a different colour. This code is *extremely* similar to the code you wrote for the earlier exercise. How would you describe these distributions. Are Lake Ellesmere's log ChlA values skewed? What can you provide as evidence for your answer?

```{r 04-logs_check, echo=FALSE, include=FALSE, warning=FALSE, message=FALSE}
