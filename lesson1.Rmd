...
```{r, fig.align='center', out.width="3in", fig.cap="What's inside the computer", echo=FALSE}
include_graphics("images/computer.png" )
```
...
```{r, out.width = "6in", fig.cap = "All The Parts", echo=FALSE, fig.align='center'}
include_graphics("images/language_ide_machine.png")
```
...
```{r, out.width = "2.5in", fig.align='center', fig.cap = "Confused Dog", echo = FALSE}
include_graphics("images/dog.jpg")
```
...
1.  Launch RStudio. [^1]. If you have installed R and RStudio on your own machine, you should have a Desktop (Windows) or Dock (Mac OS) icon that you can click to launch RStudio. If not, search through the Programs start-up menu (Windows) or Applications (Mac OS).
...
[^1]: If running For instructions to launch the Student Desktop follow <https://blogs.otago.ac.nz/studentit/student-desktop/student-desktop-own-device/>

**4 + 5**

If everything is working as it should, your screen should look like this (the contents of the Files pane may be different):

```{r, fig.align='center', out.width= "6.5in", fig.pos="H", fig.cap = "First R Command", echo = FALSE}
include_graphics("images/first_command.PNG")
```
...
```{r, fig.align='center', out.width="3in", fig.cap="How Variables Work", echo = FALSE}
include_graphics("images/computer_with_variable.png")
```
...
```{r, fig.align='center', out.width="3.5in", fig.cap = "Making an R File", echo = FALSE}
include_graphics("images/make_script.png")
```
...
```{r, fig.align='center', out.width = "6in", fig.cap = "New Script", fig.pos = 'H', echo = FALSE}
...
```{r, fig.align='center', out.width="4in", fig.cap = "Create an R Markdown File", fig.pos = "H", echo = FALSE}
include_graphics("images/make_rmd.png")
```
...
```{r, fig.align='center', out.width = "4in", fig.pos = "H", fig.cap = "R Markdown Dialogue", echo = FALSE}
include_graphics("images/markdown_dialogue.png")
```

3\. RStudio will create a new file and open it in a new tab. The file is untitled, so save it and give it a sensible name.

```{r, fig.align='center', fig.cap = "A New R Markdown File", out.width = "5in", echo = FALSE, fig.pos = "H"}
include_graphics("images/markdown_template.png")
```
...
```{r, fig.align='center', fig.cap = "The Knit Button", out.width = "3in", echo = FALSE, fig.pos = "H"}
include_graphics("images/markdown_knit_button.png")
```
