...
> #### Associated Material
>
> Zoom notes: [Zoom Notes 04 - Communicate](zoom_notes_04.html)
>
> Readings:
>
...
include_graphics("images/04-new_rmd.png")
```
...
include_graphics("images/04-rmd-editor.png")
```

\

```{r, echo = FALSE, out.width = "90%", fig.align='center', fig.cap="Visual view"}
include_graphics("images/04-rstudio-rmd-visual.png")
```
