...
> #### Associated Material
>
> Zoom notes: [Zoom Notes 05 - Summarising data](zoom_notes_05_summarise.html)
>
> Readings
>
...
> 
> ```{r, eval = FALSE}
> download.file(url = "https://raw.githubusercontent.com/rtis-training/2023-s1-r4ssp/main/docs/data/NZ_lake_chla_data.csv", 
...
>
> The second option is in a web browser go to https://raw.githubusercontent.com/rtis-training/2023-s1-r4ssp/main/docs/data/NZ_lake_chla_data.csv and then save the page using `Save As` and give it the name "NZ_lake_chla_data.csv". Save it to your data location.
...
```{r 05-histograms, warning=FALSE, message=FALSE}
...
```{r 05-lake_hists, warning=FALSE, message=FALSE}
...
```{r 05-categorical_distribution_dodge, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r 05-scatterplot, warning=FALSE, message=FALSE}
...
```{r 05-comparing, echo=FALSE, warning=FALSE, message=FALSE}
library(gridExtra)
