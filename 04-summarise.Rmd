...
>
> The second option is in a web browser go to https://raw.githubusercontent.com/rtis-training/2022-s1-r4ssp/main/docs/data/NZ_lake_chla_data.csv and then save the page using `Save As` and give it the name "NZ_lake_chla_data.csv". Save it to your data location.
