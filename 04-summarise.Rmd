...
```{r 04-lake_hists, echo=FALSE, warning=FALSE, message=FALSE}
ggplot(data = lakes) +
...
```{r 04-lake_hists_solution, warning=FALSE, message=FALSE, eval=FALSE, class.source = "fold-hide"}
ggplot(data = lakes) +
  geom_histogram(aes(x = ChlA, color = LakeName, fill=LakeName), position="dodge")
